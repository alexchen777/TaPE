...
def main():
    ...
    checkpoints_path = "/home/chenwenxiang/tape/relation-pre_2" # save the parameters during training
    result_path = "/home/chenwenxiang/tape/relation-pre_2" # save the results of each epoch
    label_smoothing = 0.0
    seed = 0
    warmup = 10000 # 10000
    factor = 1
